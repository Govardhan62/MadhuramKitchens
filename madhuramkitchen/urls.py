...
blog_items, events, edit_items,edit_menuitem,delete_menuitem,category_list,delete_category,edit_category,view_bag,add_to_bag,about,contact,flatter
...
urlpatterns = [
    ...
    path('flatter',flatter,name='flatter'),
]
